...
Furthermore, let $X$ be the combined dataset consisting of all $n=n_1+n_2$ observations. For each of these %two
...
\end{align*}
thereby obtaining loadings $\eta_{1k}, \eta_{2k}, \eta_k$ and variance components $\lambda_{1k}, \lambda_{2k}, \lambda$ for $k=1,\dotsc,d$.
\end{enumerate}
...
as inspired by Lin et al. \citeyearpar{LinEtAl2002}.
