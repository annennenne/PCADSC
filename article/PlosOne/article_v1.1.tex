...
\begin{flushleft}
{\Large
\textbf\newline{Exploratory data structure comparisons: Three new visual tools based on Principal Component Analysis} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
% Insert author names, affiliations and corresponding author email (do not include titles, positions, or degrees).
\\
Anne Helby Petersen\textsuperscript{1*\textcurrency},
Bo Markussen\textsuperscript{2\textcurrency},
Karl Bang Christensen\textsuperscript{1\textcurrency},
\\
\bigskip
\textbf{1} Department of Public Health, University of Copenhagen, Copenhagen, Denmark
\\
\textbf{2} Department of Mathematical Sciences, University of Copenhagen, Copenhagen, Denmark
\\
\bigskip
...
\textcurrency These authors contributed equally to this work.
